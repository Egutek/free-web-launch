...
import {
  ...
  d as getStartOptions,
  f as runWithStartContext,
  i as TSS_SERVER_FUNCTION,
  l as flattenMiddlewares,
  n as TSS_CONTENT_TYPE_FRAMED_VERSIONED,
  o as X_TSS_SERIALIZED,
  p as safeObjectMerge,
  r as TSS_FORMDATA_CONTEXT,
  s as createNullProtoObject,
  t as FrameType,
  u as getStartContext,
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CZvJzv-A.mjs");
...
var manifest = {
  ab76cd8d0cf55eac356d439e746cc2fb9137abacbe0deee6302ba943a04b46b9: {
    functionName: "extractOperatorsFn_createServerFn_handler",
    importer: () => import("./aiServerFn-DsN_6dGI.mjs"),
  },
};
