...
//#region node_modules/.nitro/vite/services/ssr/assets/router-D3L9w8Aa.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_dev_runtime = require_jsx_dev_runtime();
var styles_default = "/assets/styles-bcxVB1by.css";
...
var $$splitComponentImporter = () => import("./routes-BcFWY9iY.mjs");
var rootRouteChildren = { IndexRoute: createFileRoute("/")({
	head: () => ({ meta: [
		{ title: "ZF Operativa Ostrov — operativní řízení směn skladu" },
		{
			name: "description",
			content: "Živé rozdělení operátorů na oddělení PICK (HOVC, HOVS, Putaway, VAS, OBWF, VNA, OBWI), přesuny, šablony směn a reporty pro vedení."
		},
		{
			property: "og:title",
			content: "ZF Operativa Ostrov — řízení směn skladu"
		},
		{
			property: "og:description",
			content: "Sdílená online nástěnka směny: obsazení oddělení, přesuny operátorů, šablony a historie v reálném čase."
		},
		{
			property: "og:type",
			content: "website"
